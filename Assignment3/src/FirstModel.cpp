...
void FirstModel::connectOrderToCashier(Cashier *processCashier, Order *processOrder) {
...
void FirstModel::connectOrderToBarista(Barista *processBarista, Order *processOrder) {
...
void FirstModel::shoppingSystem(vector<Order> *orders, vector<Barista> *baristas, vector<Cashier> *cashiers) {
